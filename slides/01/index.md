...
また、Node.js には **NPM (Node Package Manager)** という CLI アプリも付属している。
NPM を利用することで、*ネット上にアップされている様々な JS プログラム*を自分のマシンにインストールしたり、自分の JS プログラムに*モジュール*として組み込んだりすることが簡単に行える。
